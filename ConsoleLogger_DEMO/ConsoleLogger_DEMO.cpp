...
{
    ///////////////////////////////////////////////////////////////////////
    printf ("Hi , i'm the main-process , and  i'm going to show you 2 more"
        " consoles...");
    ...
    coloured_console1.cprintf
        (CConsoleLoggerEx::COLOR_RED|CConsoleLoggerEx::COLOR_BACKGROUND_BLACK,
            "Another console");
