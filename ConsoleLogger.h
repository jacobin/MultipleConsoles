///////////////////////////////////////////////////////////////////////////////
#ifndef AFX_CONSOLELOGGER_H__294FDF9B_F91E_4F6A_A953_700181DD1996__INCLUDED_
...
#pragma message ("***********************************************************")
#pragma message ("Notice (performance-warning): you are not using the " )
#pragma message ("\tMicrosoft Platform SDK,we'll use CRITICAL_SECTION " )
#pragma message ("\tinstead of InterLocked operation" )
#pragma message ("***********************************************************")
#else
...
protected:
    ...
    // * "Performance-Conscious Thread Synchronization", Jeffrey Richter, 
    ...
    inline void EnterCriticalSection(void)
        {
            while(InterlockedCompareExchange(&m_fast_critical_section,1,0)!=0)
            {
                Sleep(0);
            }
        }
    ...
    inline void LeaveCriticalSection(void) { m_fast_critical_section=0; }
    ...
    virtual long AddHeaders(void) { return 0;}
...
public:
    ...
    enum enumColors
    {
        ...
        COLOR_BACKGROUND_WHITE =COLOR_BACKGROUND_RED|COLOR_BACKGROUND_GREEN
    ...
    DWORD GetCurrentColor(void) { return m_dwCurrentAttributes; }
    void SetCurrentColor(DWORD dwColor) { m_dwCurrentAttributes=dwColor; }

protected:
    virtual long AddHeaders(void)
    {   
        // Thnx to this function, the "Helper" can see that we are 
        //   "extended" logger !!!
